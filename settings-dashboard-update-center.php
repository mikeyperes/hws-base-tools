...
function display_settings_update_center() {
    ...
    <div class="hws-uc-section">
        ...
        <div class="hws-uc-section-body">
            <p style="font-size:13px;color:#646970;margin:0 0 12px;">These URLs can trigger updates without logging in. Share carefully. Default output is JSON. Append <code>&format=html</code> for styled page, <code>&format=text</code> for plain text.</p>
