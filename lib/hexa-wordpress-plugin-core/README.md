...
- `PluginChecks`: shared required-plugin definitions, status checks, reusable collapsible plugin inventory tables, Font Awesome-style green/red indicators, AJAX install/activate actions, update-cache refresh, and activity-log UI.
