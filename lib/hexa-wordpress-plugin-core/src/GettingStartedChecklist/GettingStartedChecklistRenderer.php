...
final class GettingStartedChecklistRenderer {
    ...
    public function render(): void {
        ...
        <div id="<?php echo esc_attr( $root_id ); ?>" class="hpc-ui hpc-gsc" data-hpc-getting-started-checklist data-ajax-url="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" data-run-action="<?php echo esc_attr( $this->config->run_action() ); ?>" data-nonce-field="<?php echo esc_attr( $this->config->nonce_field() ); ?>" data-nonce="<?php echo esc_attr( $nonce ); ?>">
            ...
            ?>
                ...
                <section class="hpc-gsc-log" aria-live="polite">
                    <div class="hpc-gsc-log-head">
                        <div>
                    ...
                    <div class="hpc-gsc-log-body" data-gsc-log-body>
    ...
    private function assets( string $root_id ): string {
        ...
        <style>
            ...
            #<?php echo esc_attr( $root_id ); ?> .hpc-gsc-log-head{align-items:center;background:#111c2a;border-bottom:1px solid #263241;display:flex;gap:12px;justify-content:space-between;padding:14px 16px}
            ...
            @media(max-width:760px){#<?php echo esc_attr( $root_id ); ?> .hpc-gsc-row{grid-template-columns:34px minmax(0,1fr)}#<?php echo esc_attr( $root_id ); ?> .hpc-gsc-row-action{grid-column:2}#<?php echo esc_attr( $root_id ); ?> .hpc-gsc-subtask-row{margin-left:0}#<?php echo esc_attr( $root_id ); ?> .hpc-gsc-log-row{grid-template-columns:1fr}}
        </style>
        <script>
        (function(){
