...
final class RuntimeOptions {
    ...
    public static function seed_defaults() {
        ...
        $defaults = [
            ...
            'hws_update_urls_enabled'       => 'no',
            'hws_login_urls_enabled'        => 'no',
        ];
    ...
    public static function get_master_secret() {
        return ( new SecretStore( 'hws_master_secret_key' ) )->get();
    }

    public static function set_master_secret( string $secret ): bool {
        return ( new SecretStore( 'hws_master_secret_key' ) )->set( $secret );
    }
}
