...
final class DashboardRegistry {
    ...
    private function register_defaults(): void {
        ...
        $this->add( new DashboardModuleDefinition( 'page-layout-styling', 'Default Page Content', [ \HWS\BaseTools\PageLayoutStyling\PageLayoutAdmin::class, 'render' ] ) );
    ...
    private function ajax_file_map(): array {
        return [
            ...
            'hws_plugin_library_'                => [ 'settings-dashboard-check-plugins.php' ],
            'hws_plugin_status_'                 => [ 'settings-dashboard-check-plugins.php' ],
            'hws_unrecommended_plugins_'         => [ 'settings-dashboard-check-plugins.php' ],
