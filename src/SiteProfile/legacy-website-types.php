...
function get_website_type_presets() {
    return [
        ...
        'person_website' => [
            'name'        => 'Person Website',
            'description' => 'Personal website configuration with HWS-owned team members and testimonials.',
            'icon'        => '👤',
            'snippets'    => [
        ...
        'organization_website' => [
            ...
            'description' => 'Organization configuration with HWS-owned team member and testimonial content types.',
            'icon'        => 'building',
            'snippets'    => [
                'smp_enable_cpt_teammember',
                'enable_cpt_testimonial',
