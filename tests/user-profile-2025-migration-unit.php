...
$user_meta = [
    ...
    2 => [
        ...
        'threads_url'             => 'https://www.threads.net/@example',
        '_threads_url'            => 'field_legacy_threads',
...
$expect( 'https://www.threads.net/@example' === ( $migrated['urls']['threads'] ?? '' ), 'legacy Threads URL reaches the canonical URLs group' );
