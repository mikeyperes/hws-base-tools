...
launch_expect( in_array( 'set_memory_limit', $quick_ids, true ) && str_contains( serialize( $standard ), '4096M' ), 'Quick Start sets the exact requested 4 GB WordPress memory policy' );
