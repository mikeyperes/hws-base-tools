...
function display_wp_admin_settings_page() {
    ...
    if ( get_option( 'enable_comments_management', false ) ) {
...
function render_summary_section() {
    ...
    $xml_available = extension_loaded( 'xml' );
    $intl_available = extension_loaded( 'intl' );
    $opcache_available = extension_loaded( 'Zend OPcache' );
    $brotli_available = extension_loaded( 'brotli' ) || function_exists( 'brotli_compress' );
    ...
    <div class="hws-summary-section" style="margin-top: 20px;">
        ...
        <div class="hws-summary-grid">
            <div class="hws-summary-card">
                ...
                <p>Memory: <strong><?php echo esc_html( $memory_limit ); ?></strong></p>
            </div>
            <div class="hws-summary-card">
                <h4>Upload Limits</h4>
            ...
            <div class="hws-summary-card">
                ...
                <p class="<?php echo $imagick_available ? 'status-ok' : 'status-warn'; ?>">
                    Imagick: <?php echo $imagick_available ? '✅' : '⚠️'; ?>
                </p>
                <p class="<?php echo $gd_available ? 'status-ok' : 'status-bad'; ?>">
                    GD: <?php echo $gd_available ? '✅' : '❌'; ?>
                </p>
                <p class="<?php echo $curl_available ? 'status-ok' : 'status-bad'; ?>">
                    cURL: <?php echo $curl_available ? '✅' : '❌'; ?>
                </p>
                <p class="<?php echo $opcache_available ? 'status-ok' : 'status-warn'; ?>">
                    OPcache: <?php echo $opcache_available ? '✅' : '⚠️'; ?>
                </p>
                <p class="<?php echo $brotli_available ? 'status-ok' : 'status-warn'; ?>">
                    Brotli: <?php echo $brotli_available ? '✅' : '⚠️'; ?>
                </p>
            </div>
            <div class="hws-summary-card">
                <h4>More Extensions</h4>
                <p class="<?php echo $zip_available ? 'status-ok' : 'status-warn'; ?>">
                    Zip: <?php echo $zip_available ? '✅' : '⚠️'; ?>
                </p>
                <p class="<?php echo $mbstring_available ? 'status-ok' : 'status-warn'; ?>">
                    mbstring: <?php echo $mbstring_available ? '✅' : '⚠️'; ?>
                </p>
                <p class="<?php echo $xml_available ? 'status-ok' : 'status-warn'; ?>">
                    XML: <?php echo $xml_available ? '✅' : '⚠️'; ?>
                </p>
                <p class="<?php echo $intl_available ? 'status-ok' : 'status-warn'; ?>">
                    intl: <?php echo $intl_available ? '✅' : '⚠️'; ?>
                </p>
            </div>
        </div>
    </div>
